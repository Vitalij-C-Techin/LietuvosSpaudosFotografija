      ...
      en: {
        translation: {
          ...
          registrationPage: {
            ...
            passwordPattern: 'Password must contain lowercase, uppercase latin letters, numbers and special symbols !@#$%^&*().',
      ...
      lt: {
        translation: {
          ...
          registrationPage: {
            ...
            passwordPattern: 'Slaptažodį turi sudaryti mažosios, didžiosios lotyniškos raidės, skaitmenys bei specialieji simboliai !@#$%^&*().',
